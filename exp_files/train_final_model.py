...
class Exp(rumex_leaf_exp):
    def __init__(self):
        ...
        self.target_mode_conf = {
            ...
            "do_kphm": True,
            "do_obb": True,
            "do_da": True,  # Set to True for domain adaptation
        ...
        # DA settings
        # Source domain (iNaturalist) -> For normal + DA training
