...
class WandbLogger(object):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        from maad_centernet.data import RumexLeavesDataset
        ...
        self.log_checkpoints = (
            log_checkpoints == "True" or log_checkpoints == "true"
        )
            ...
            image_wise_data.update(
                {
                    img_id: {
                        ...
                        "scores": [
                            score.detach().cpu().numpy().item()
                            for score in act_scores
                        ],
                        "categories": [
                            int(act_cls[ind]) for ind in range(len(act_box))
                        ],
                    }
                }
            )
